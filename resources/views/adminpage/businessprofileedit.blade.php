        ...
        <div class="col-lg-8 col-md-12">
            <div class="dashboard-list-box margin-top-0">
                ...
                <div class="dashboard-list-box-static">
                    ...
                    <form action="{{url('admin/business/saveprofile')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <!-- Avatar -->
                        ...
                        <button class="button margin-top-15 gray" type="button" onclick="window.location='{{url('/admin/business')}}'">Cancel</button>
                    </form>
                </div>
            </div>
        </div>
