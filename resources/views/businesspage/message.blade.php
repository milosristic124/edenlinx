                    ...
                    <div class="my-profile">
                        <table style="width:100%;">
                            <tr>
                                ...
                                <img src="{{asset($message->userprofile)}}" alt="" id="profile_img" style="width:50px; height:50px;">
                                @else
                                ...
                                <td style="width: *; vertical-align:top">
                                    <table style="width: 100%; height:100%;">
                                        <tr><td style="font-weight:800">{{$message->name}}&nbsp;&nbsp;
                                        @if($message->direct == 0 && $message->read == 0)
