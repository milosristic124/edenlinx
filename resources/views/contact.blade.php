...
@section('content')
    {{--<div class="container">--}}
        <div class="main-search-container margin-bottom-60" id="contact-main-image" 
        @if($setting->contactpageimage != "" && $setting->contactpageimage != null)
            data-background-image="{{asset($setting->contactpageimage)}}"
        @else
            data-background-image="{{asset('images/contactback.png')}}"
        @endif
        >
        </div>
    {{--</div>--}}
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <section id="contact">
                    ...
                    <form method="get" action="{{url('customer/postcontact')}}" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <div>
