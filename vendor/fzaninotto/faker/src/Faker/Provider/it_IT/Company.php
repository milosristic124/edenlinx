...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $bsWords = array(
        array(
            'partnerships', 'comunità', 'ROI', 'soluzioni', 'e-services', 'nicchie', 'tecnologie', 'contenuti', 'supply-chains', 'convergenze', 'relazioni', 'architetture', 'interfacce', 'mercati', 'e-commerce', 'sistemi', 'modelli', 'schemi', 'reti', 'applicazioni', 'metriche', 'e-businesspage', 'funzionalità', 'esperienze', 'webservices', 'metodologie'
        ),
        array(
