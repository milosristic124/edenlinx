...
(function($){
    ...
    function mainMap() {
      ...
      for(var ind = 0; ind < bInfo.length; ind++){
          locations.push([ locationData('/business/info/'+bInfo[ind]['id'],bInfo[ind]['image'],bInfo[ind]['title'],bInfo[ind]['postcode']+' '+bInfo[ind]['address']+' '+bInfo[ind]['city'], bInfo[ind]['rating'], '0'), bInfo[ind]['lat'], bInfo[ind]['long'], ind, '<h4><strong>'+bInfo[ind]['title'].substr(0,2)+'</strong></h4>']);
      }
